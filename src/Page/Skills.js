  ...
  return (
    <section id="skills" className="mt-18 w-full px-18 relative  ">
      ...
      <div className="rounded-xl w-full h-100   bg-[#7f2fff]">
        <h1 className='text-white mx-auto text-5xl font-semibold text-center py-17'>Skills</h1>
      </div>
      
      <div className="w-full bg-white  flex justify-between items-center gap-8 px-22 -mt-50 relative z-10">
        
        <div className="w-full bg-white border rounded-xl mx-auto text-center border-gray-300 shadow p-10 pb-4 flex flex-col items-center">
          <IoIosGitNetwork className='text-5xl text-[#3c65ff] rotate-270'/>
          <h1 className='text-black-900 foont-bold text-2xl py-5 text-center'>Back-end Developer</h1>
